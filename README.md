...
[![Windows](https://img.shields.io/badge/Windows-10%20%7C%2011-0078D4?logo=windows)](https://github.com/huzaifahshahid71-ops/Game-Covers) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE) [![Release](https://img.shields.io/badge/Download-GitHub%20Release-6f42c1)](https://github.com/huzaifahshahid71-ops/Game-Covers/releases/tag/Release)

**[⬇ Download the Windows release](https://github.com/huzaifahshahid71-ops/Game-Covers/releases/tag/Release)**
...
- **Binary staging branch:** `releases`
- **Public download page:** [GitHub Releases](https://github.com/huzaifahshahid71-ops/Game-Covers/releases/tag/Release)

The `releases` branch is kept separate from development so compiled Windows builds do not clutter the source tree. For normal users, the GitHub **Releases** page is the preferred download location.
